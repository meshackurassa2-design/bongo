...
const getStyles = (COLORS: any) => StyleSheet.create({
  ...
  searchBar: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.card, borderRadius: 14, marginHorizontal: 16, paddingHorizontal: 14, minHeight: 50, gap: 10, marginBottom: 8 },
  input: { flex: 1, color: COLORS.textPrimary, fontSize: 16, height: '100%', paddingVertical: 0 },
